            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        <img src="https://res.cloudinary.com/durosbtet/image/upload/v1733235289/logo.png" class="h-8 me-3" alt="FlowBite Logo" />
                        <span
                            class="self-center text-xl font-semibold sm:text-xl whitespace-nowrap dark:text-white">Daanc Academy</span>
                    </a>
                </div>
    ...
    <div class="p-4 sm:ml-64 bg-white dark:bg-gray-800">
        <div class="p-4 mt-14">
            @if (Route::currentRouteName() === 'dashboard')
                @include('category.admin.chart')
            @endif
            @if (Route::currentRouteName() === 'categories')
                @include('category.admin.index')
            @endif
            ...
            @if (Route::currentRouteName() === 'category-detail')
                @include('category.admin.detail.index')
            @endif
            @if (Route::currentRouteName() === 'category-detail.create')
